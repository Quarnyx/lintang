        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="" method="get" class="row g-3">
                    <input type="hidden" name="halaman" value="laporan-penjualan">
                    <div class="col-md-6">
...
<?php if (isset($_GET['dari_tanggal']) && isset($_GET['sampai_tanggal'])) { ?>
    <div class="row">
        <div class="col-12">
            <div class="card">
                <h4 class="text-center mt-3 mb-3"><b>TOKO LINTANG</b><br><b>LAPORAN PENJUALAN</b><br>
                ...
                <div class="card-body">
                    ...
                    <table id="tabel-data" class="table table-bordered table-bordered dt-responsive nowrap">
                        ...
                        <tbody>
                            ...
                            $harga_beli = 0;
                            $harga_jual = 0;
                            $query = mysqli_query($conn, "SELECT * FROM view_keranjang WHERE tanggal_transaksi BETWEEN '$_GET[dari_tanggal]' AND '$_GET[sampai_tanggal]'");
