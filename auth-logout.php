...
<body class="authentication-bg authentication-bg-pattern">
                ...
                <div class="col-md-8 col-lg-6 col-xl-4">
                    <div class="card bg-pattern">
                        ...
                        <div class="card-body p-4">
                            ...
                            <div class="text-center">
                                ...
                                <p class="text-muted"> Berhasil logout. </p>
                            </div>
                    ...
                    <div class="row mt-3">
                        <div class="col-12 text-center">
                            <p class="text-white-50">Kembali <a href="auth-login.php" class="text-white ms-1"><b>Log
                                        In</b></a></p>
                        </div> <!-- end col -->
                    </div>
                    <!-- end row -->
    ...
    <footer class="footer footer-alt">
        2015 -
        <script>document.write(new Date().getFullYear())</script> &copy; Toko Lintang
    </footer>
